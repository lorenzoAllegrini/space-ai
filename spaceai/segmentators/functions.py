...
def apply_statistic_to_segments(
    ...
    Args:
        ...
        func: Function to apply to the windows. Must accept a 2D array of windows.
        window_shape: Size of the sliding window.
        step_duration: Stride of the sliding window.
        preprocess: Optional function to apply to the data BEFORE windowing (e.g., smoothing, diff).
...
def count_peaks_vectorized(windows: np.ndarray) -> np.ndarray:
    ...
    Designed to be used with apply_statistic_to_segments.
    """
